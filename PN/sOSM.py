...
if __name__ == "__main__":
    ...
    N = int(0.5 * (L_max + 1) * (L_max + 2))  # total term in the sum of l and m indices is 0.5 * (L_max + 1) * (L_max + 2)
    ...
    for alpha_p in range(2): # 0 is for cosine, 1 is for sine
        for l_p in range(L_max + 1):
            for m_p in range(l_p + 1): # TODO: change this to start m_p at 1, not 0
